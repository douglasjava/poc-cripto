...
@NamedQueries({ @NamedQuery(name = "Registros.findAll", query = "SELECT r FROM Registros r") })
@DynamicUpdate
@AllArgsConstructor
public class Registros implements Serializable {
	...
	@Column(name = "id_contrato_db_rj")
	private Long idContratoDbRj;
	
	@Column(name = "id_registro_db_rj")
	private Long idRegistroDbRj;
	
	@Column(name = "id_transacao_db_rj")
	private Long idTransacao;

	@Basic(optional = false)
	@Column(name = "im_certidao_iteor", columnDefinition = "bytea")
	private byte[] imCertidaoIteor;
	...
	public Registros(Integer idRegistro, Date dtCadastro, Short tpDevedor, Short tpOrigem, BigDecimal vlDivida, BigDecimal vlEncargos, BigDecimal pcJurosAno, BigDecimal pcCorrecao, Date dtContrato, Date dtUltAtualiza, String nuContrato,
			Date dtFimContrato, String nmDevedor, Boolean inMulta, Boolean inMora, Integer idUsuarioAtualiza, Boolean inAtivo, Integer qtTotalParcelas, Integer qtTotalMeses, BigDecimal pcJurosMesCont, BigDecimal vlComissao) {
		this.idRegistro = idRegistro;
	...
	public Long getIdContratoDbRj() {
		return idContratoDbRj;
	}

	public void setIdContratoDbRj(Long idContratoDbRj) {
		this.idContratoDbRj = idContratoDbRj;
	}

	public Long getIdRegistroDbRj() {
		return idRegistroDbRj;
	}

	public void setIdRegistroDbRj(Long idRegistroDbRj) {
		this.idRegistroDbRj = idRegistroDbRj;
	}
	...
	public byte[] getImCertidaoIteor() {
		return imCertidaoIteor;
	}

	public void setImCertidaoIteor(byte[] imCertidaoIteor) {
		this.imCertidaoIteor = imCertidaoIteor;
	}

	@Override
	public String toString() {
		return "Registros [idRegistro=" + idRegistro + ", " + "dtCadastro=" + dtCadastro + ", " + "tpDevedor=" + tpDevedor + ", " + "nuCnpj=" + nuCnpj + ", " + "nuCpf=" + nuCpf + ", " + "dsEmail=" + dsEmail + ", " + "nuDdd1=" + nuDdd1 + ", "
				+ "nuTelefone1=" + nuTelefone1 + ", nuDdd2=" + nuDdd2 + ", " + "nuTelefone2=" + nuTelefone2 + ", " + "tpOrigem=" + tpOrigem + ", " + "vlDivida=" + vlDivida + ", " + "vlEncargos=" + vlEncargos + ", " + "pcJurosAno=" + pcJurosAno + ", "
				+ "pcCorrecao=" + pcCorrecao + ", " + "dtContrato=" + dtContrato + ", dtUltAtualiza=" + dtUltAtualiza + ", " + "nuDdi1=" + nuDdi1 + ", nuDdi2=" + nuDdi2 + ", " + "nuContrato=" + nuContrato + ", dtFimContrato=" + dtFimContrato + ", "
				+ "nmDevedor=" + nmDevedor + ", vlContrato=" + vlContrato + ", vlIof=" + vlIof + ", inMulta=" + inMulta + ", inMora=" + inMora + ", idUsuarioAtualiza=" + idUsuarioAtualiza + ", dtAnulacao=" + dtAnulacao + ", inAtivo=" + inAtivo
				+ ", dsMensagem=" + dsMensagem + ", imXmlEspelho=" + Arrays.toString(imXmlEspelho) + ", vlRegistro=" + vlRegistro + ", qtTotalParcelas=" + qtTotalParcelas + ", qtTotalMeses=" + qtTotalMeses + ", pcJurosMesCont=" + pcJurosMesCont
				+ ", vlComissao=" + vlComissao + ", imCertidao=" + Arrays.toString(imCertidao) + ", dtEmisCertidao=" + dtEmisCertidao + ", dtBaixa=" + dtBaixa + ", vlParcela=" + vlParcela + ", dtParcela1=" + dtParcela1 + ", dtLiberaCredito="
				+ dtLiberaCredito + ", nuGrupoConsorcio=" + nuGrupoConsorcio + ", nuCotaConsorcio=" + nuCotaConsorcio + ", vlTxMulta=" + vlTxMulta + ", vlTxMora=" + vlTxMora + ", nuIp=" + nuIp + ", idCredor=" + idCredor + ", idEndereco=" + idEndereco
				+ ", idEnderecoGarantidor=" + idEnderecoGarantidor + ", idMunicipioContrato=" + idMunicipioContrato + ", idStatus=" + idStatus + ", idTipoContrato=" + idTipoContrato + ", idTipoFinanc=" + idTipoFinanc + ", idUf=" + idUf
				+ ", idUsuarioRegistro=" + idUsuarioRegistro + ", inPenalidade=" + inPenalidade + ", nmGarantidor=" + nmGarantidor + ", nuCnpjGarantidor=" + nuCnpjGarantidor + ", nuCpfGarantidor=" + nuCpfGarantidor + ", nuDdd1Garantidor="
				+ nuDdd1Garantidor + ", nuDdd2Garantidor=" + nuDdd2Garantidor + ", nuTelefone1Garantidor=" + nuTelefone1Garantidor + ", nuTelefone2Garantidor=" + nuTelefone2Garantidor + ", tpAditivo=" + tpAditivo + ", dsClausulaLegal="
				+ dsClausulaLegal + ", dsEmailGarantidor=" + dsEmailGarantidor + ", dtCompra=" + dtCompra + ", tpGarantidor=" + tpGarantidor + ", nuDdi1Garantidor=" + nuDdi1Garantidor + ", nuDdi2Garantidor=" + nuDdi2Garantidor + ", idIndiceCorrecao="
				+ idIndiceCorrecao + "]";
	}

	public Registros copyRegistros() {

		Registros registroOriginal = new Registros();
		registroOriginal.setDtCadastro(this.dtCadastro);
		registroOriginal.setTpDevedor(this.tpDevedor);
		registroOriginal.setNuCnpj(this.nuCnpj);
		registroOriginal.setNuCpf(this.nuCpf);
		registroOriginal.setDsEmail(this.dsEmail);
		registroOriginal.setNuDdd1(this.nuDdd1);
		registroOriginal.setNuTelefone1(this.nuTelefone1);
		registroOriginal.setNuDdd2(this.nuDdd2);
		registroOriginal.setNuTelefone2(this.nuTelefone2);
		registroOriginal.setTpOrigem(this.tpOrigem);
		registroOriginal.setVlDivida(this.vlDivida);
		registroOriginal.setVlEncargos(this.vlEncargos);
		registroOriginal.setPcJurosAno(this.pcJurosAno);
		registroOriginal.setPcCorrecao(this.pcCorrecao);
		registroOriginal.setDtContrato(this.dtContrato);
		registroOriginal.setDtUltAtualiza(this.dtUltAtualiza);
		registroOriginal.setNuDdi1(this.nuDdi1);
		registroOriginal.setNuDdi2(this.nuDdi2);
		registroOriginal.setNuContrato(this.nuContrato);
		registroOriginal.setDtFimContrato(this.dtFimContrato);
		registroOriginal.setNmDevedor(this.nmDevedor);
		registroOriginal.setVlContrato(this.vlContrato);
		registroOriginal.setVlIof(this.vlIof);
		registroOriginal.setInMulta(this.inMulta);
		registroOriginal.setInMora(this.inMora);
		registroOriginal.setIdUsuarioAtualiza(this.idUsuarioAtualiza);
		registroOriginal.setDtAnulacao(this.dtAnulacao);
		registroOriginal.setInAtivo(this.inAtivo);
		registroOriginal.setDsMensagem(this.dsMensagem);
		registroOriginal.setVlRegistro(this.vlRegistro);
		registroOriginal.setQtTotalParcelas(this.qtTotalParcelas);
		registroOriginal.setQtTotalMeses(this.qtTotalMeses);
		registroOriginal.setPcJurosMesCont(this.pcJurosMesCont);
		registroOriginal.setVlComissao(this.vlComissao);
		registroOriginal.setDtBaixa(this.dtBaixa);
		registroOriginal.setVlParcela(this.vlParcela);
		registroOriginal.setDtParcela1(this.dtParcela1);
		registroOriginal.setDtLiberaCredito(this.dtLiberaCredito);
		registroOriginal.setNuGrupoConsorcio(this.nuGrupoConsorcio);
		registroOriginal.setNuCotaConsorcio(this.nuCotaConsorcio);
		registroOriginal.setVlTxMulta(this.vlTxMulta);
		registroOriginal.setVlTxMora(this.vlTxMora);
		registroOriginal.setNuIp(this.nuIp);
		registroOriginal.setIdCredor(this.idCredor);
		registroOriginal.setIdEndereco(this.idEndereco);
		registroOriginal.setIdMunicipioContrato(this.idMunicipioContrato);
		registroOriginal.setIdStatus(this.idStatus);
		registroOriginal.setIdTipoContrato(this.idTipoContrato);
		registroOriginal.setIdTipoFinanc(this.idTipoFinanc);
		registroOriginal.setIdUf(this.idUf);
		registroOriginal.setIdUsuarioRegistro(this.idUsuarioRegistro);
		registroOriginal.setInPenalidade(this.inPenalidade);
		registroOriginal.setDsClausulaLegal(this.dsClausulaLegal);
		registroOriginal.setDtCompra(this.dtCompra);
		registroOriginal.setIdIndiceCorrecao(this.idIndiceCorrecao);
		registroOriginal.setTpOperacao(this.tpOperacao);
		registroOriginal.setUfimovelcredor(this.ufimovelcredor);
		registroOriginal.setUfliberacaocredito(this.ufliberacaocredito);
		registroOriginal.setIdRemessa(this.idRemessa);
		registroOriginal.setNumeroSequencialTransacao(this.numeroSequencialTransacao);
		registroOriginal.setCodigoTransacao(this.codigoTransacao);
		registroOriginal.setIdTransacao(this.idTransacao);
